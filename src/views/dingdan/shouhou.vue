<template>
  <div class="wrap">
    ...
    <el-table class="tab" :data="seach" height="320" border style="width: 100%">
      ...
      <el-table-column prop="stock" width="80" label="商品清单"></el-table-column>
      <el-table-column prop="discount" width="80" label="订单金额"></el-table-column>
      <el-table-column prop="status" width="80" label="收获信息">
        <template slot-scope="scope">
          <span>{{scope.row.status | pay}}</span>
        </template>
      </el-table-column>
      <el-table-column prop="ischeck" width="80" label="买家">
        <template slot-scope="scope">
          <span>{{scope.row.ischeck | check}}</span>
        </template>
      </el-table-column>
      <el-table-column prop="min_price" width="120" label="交易状态"></el-table-column>
