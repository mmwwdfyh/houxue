<template>
  <div class="wrap">
    ...
    <el-table class="tab" :data="seach" height="320" border style="width: 100%">
      ...
      <el-table-column prop="stock" width="80" label="实付款"></el-table-column>
      <el-table-column prop="discount" width="80" label="买家"></el-table-column>
      <el-table-column prop="status" width="80" label="付款方式">
        <template slot-scope="scope">
          <span>{{scope.row.status | pay}}</span>
        </template>
      </el-table-column>
      <el-table-column prop="ischeck" width="80" label="配送方式">
        <template slot-scope="scope">
