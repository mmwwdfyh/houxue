<template>
  <div class="wrap">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="管理员列表" name="all"></el-tab-pane>
      <el-tab-pane label="角色列表" name="checking"></el-tab-pane>
      <el-tab-pane label="权限列表" name="checking"></el-tab-pane>
    </el-tabs>
    <div class="fyh_toom">
      <div class="toom">
    ...
    <el-table class="tab" :data="seach" height="320" border style="width: 100%">
      <el-table-column width="280" label="用户头像">
      ...
      <el-table-column prop="discount" width="80" label="用户名"></el-table-column>
      <el-table-column prop="stock" width="80" label="所属管理员"></el-table-column>
      <el-table-column prop="ischeck" width="80" label="状态">
        <template slot-scope="scope">
