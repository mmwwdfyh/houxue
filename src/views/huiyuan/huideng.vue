<template>
  <div class="wrap">
    <div class="fyh_toom">
      <div class="toom">
        <button @click="batch">添加会员</button>
      </div>
      <div class="room">
    ...
    <el-table class="tab" :data="seach" height="320" border style="width: 100%">
      <el-table-column prop="discount" width="80" label="会员等级"></el-table-column>
      <el-table-column prop="status" width="80" label="升级条件">
        <template slot-scope="scope">
          <span>{{scope.row.status | pay}}</span>
        </template>
      </el-table-column>
      <el-table-column prop="min_price" width="120" label="状态"></el-table-column>
      <el-table-column prop="stock" width="80" label="等级序号"></el-table-column>
      <el-table-column prop="ischeck" width="80" label="折扣率(%)">
        <template slot-scope="scope">
